...
<head>
    ...
    <!-- Custom css - Only One File will be Fouced  -->
                        ...
                        <div class="rd-navbar-inner">
                            ...
                            <div class="rd-navbar-panel">
                                ...
                                <div class="rd-navbar-brand">
                                    <a class="brand" href="index.html"><img class="brand-logo-dark" src="Assets/fulllogo_transparent_nobuffer.png" alt="" width="66" height="66" /></a>
                                </div>
                            </div>
                                    ...
                                    <ul class="rd-navbar-contacts-2">
                                        ...
                                        <li>
                                            <div class="unit unit-spacing-xs">
                                                ...
                                                <div class="unit-body">
                                                    <a class="address" href="#">Rupantar Buliding, 2nd Floor, 891 Jessor Road,
                                                        Syamnagar, West Bengal, 700055</a>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
                                ...
                                <div class="rd-navbar-main">
                                    ...
                                    <ul class="rd-navbar-nav">
                                        ...
                                        <li class="rd-nav-item">
                                            <a class="rd-nav-link" href="index.html">About us</a>
                                        </li>
                                        <li class="rd-nav-item">
                                            <a class="rd-nav-link" href="index.html">Typography</a>
                                        </li>
                                        <li class="rd-nav-item">
                                            <a class="rd-nav-link" href="index.html">Contacts</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                        ...
                                        <div class="row gutters-20" data-lightgallery="group">
                                            <div class="col-6">
                                                ...
                                                <article class="thumbnail thumbnail-creative">
                                                    <a href="Assets/hero_banner_main.jpg" data-lightgallery="item">
                                                        <div class="thumbnail-creative-figure">
                                                            <img src="Assets/hero_banner_main.jpg" alt="" width="195" height="164" />
                                                        </div>
